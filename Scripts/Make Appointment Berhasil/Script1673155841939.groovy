...
WebUI.click(findTestObject('Object Repository/input_Visit Date (Required)_visit_date'))

WebUI.click(findTestObject('Object Repository/td_8'))

WebUI.setText(findTestObject('Object Repository/textarea_Comment_comment'), 'test make appointment')
